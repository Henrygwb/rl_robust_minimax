...
def read_events_file(events_filename):
    ...
    for i in range(len(events)):
        ...
        if event.shape[0] < max_len:
            ...
            event_tmp[:, 0] += np.mean(event[-20:, 1])
            event_tmp[:, 1] += np.mean(event[-20:, 1])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='/Users/Henryguo/Desktop/rl_robustness/MuJoCo/agent-zoo/SumoAnts-v0_latest')
    parser.add_argument("--out_dir", type=str, default='/Users/Henryguo/Desktop/rl_robustness/MuJoCo/agent-zoo/SumoAnts-v0_latest')
