...
if __name__ == '__main__':
    ...
    if SYMM_TRAIN:
        symmtric_learning(trainer=trainer, num_workers=NUM_WORKERS, nupdates=NUPDATES, opp_method=OPP_MODEL, 
                          select_num_episodes=SELECT_NUM_EPISODES, out_dir=out_dir)
    else:
        assymmtric_learning(trainer=trainer, num_workers=NUM_WORKERS, nupdates=NUPDATES, opp_method=OPP_MODEL,
                          select_num_episodes=SELECT_NUM_EPISODES, out_dir=out_dir)
