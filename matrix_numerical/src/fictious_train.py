...
from ppo_fictitious import learn, learn_both_parties
...
if TRAIN_BOTH_PARTIES:
    SAVE_DIR = '../agent-zoo/fictious_play/' + GAME_ENV + '_BOTH_PARTIES' + '_OPPO_Model_' + str(OPP_MODEL)
else:
    SAVE_DIR = '../agent-zoo/fictious_play/'+ GAME_ENV + '_PLAYER_' + str(TRAIN_ID) + '_OPPO_Model_' + str(OPP_MODEL)
