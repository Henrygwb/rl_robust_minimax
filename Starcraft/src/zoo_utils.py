...
def pkl_to_joblib(file_name):
    ...
    for k in keys:
        save.append(model[k])
    # save to joblib
    joblib.dump(save, 'selfplay_model')
...
#     file_name = '/home/xww0766/rl_robust_minimax/Starcraft/agent-zoo/StarCraft2_latest_1e-05/20230222_014751-1305072968/checkpoints/model/00200/model'
